...
public class D_24_Minimum_Diameter_After_Merge {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Enter the number of edges in the first tree:");
        int edges1Count = scanner.nextInt();
        int[][] edges1 = new int[edges1Count][2];
        System.out.println("Enter the edges for the first tree:");
        for (int i = 0; i < edges1Count; i++) {
            edges1[i][0] = scanner.nextInt();
            edges1[i][1] = scanner.nextInt();
        }

        // Input for second tree
        System.out.println("Enter the number of edges in the second tree:");
        int edges2Count = scanner.nextInt();
        int[][] edges2 = new int[edges2Count][2];
        System.out.println("Enter the edges for the second tree:");
        for (int i = 0; i < edges2Count; i++) {
