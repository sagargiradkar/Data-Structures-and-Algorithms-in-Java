...
public class D_31_Min_Total_Dist_Traveles {
    public static void main(String[] args) {
        // Test case: list of robot positions and factories with their positions and capacities
        List<Integer> robot = Arrays.asList(1, 5, 9);
        int[][] factory = {
            {2, 1}, // Factory at position 2 with capacity of 1 robot
            {6, 2}  // Factory at position 6 with capacity of 2 robots
        };
        
        Solution solution = new Solution();
        long result = solution.minimumTotalDistance(robot, factory);
